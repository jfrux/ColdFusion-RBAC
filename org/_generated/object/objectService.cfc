<cfcomponent name="objectService" output="false">
	...
	<cffunction name="init" access="public" output="false" returntype="org.object.objectService">
		<cfargument name="objectDAO" type="org.object.objectDAO" required="true" />
		<cfargument name="objectGateway" type="org.object.objectGateway" required="true" />
	...
	<cffunction name="getobject" access="public" output="false" returntype="object">
		...
		<cfset var object = createObject("component","org.object.object").init(argumentCollection=arguments) />
