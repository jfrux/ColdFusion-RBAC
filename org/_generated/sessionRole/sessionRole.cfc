<cfcomponent displayname="sessionRole" output="false">
	...
	--->
	<cffunction name="init" access="public" returntype="org.sessionRole.sessionRole" output="false">
	...
	PUBLIC FUNCTIONS
	--->
	<cffunction name="setMemento" access="public" returntype="org.sessionRole.sessionRole" output="false">
