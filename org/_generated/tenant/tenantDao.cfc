<cfcomponent displayname="tenantDAO" hint="table ID column = id">
	...
	<cffunction name="init" access="public" output="false" returntype="org.tenant.tenantDAO">
	...
	<cffunction name="create" access="public" output="false" returntype="boolean">
		<cfargument name="tenant" type="org.tenant.tenant" required="true" />
	...
	<cffunction name="read" access="public" output="false" returntype="org.tenant.tenant">
		<cfargument name="tenant" type="org.tenant.tenant" required="true" />
