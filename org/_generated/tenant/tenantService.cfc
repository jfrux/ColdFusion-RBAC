<cfcomponent name="tenantService" output="false">
	...
	<cffunction name="init" access="public" output="false" returntype="org.tenant.tenantService">
		<cfargument name="tenantDAO" type="org.tenant.tenantDAO" required="true" />
		<cfargument name="tenantGateway" type="org.tenant.tenantGateway" required="true" />
	...
	<cffunction name="gettenant" access="public" output="false" returntype="tenant">
		...
		<cfset var tenant = createObject("component","org.tenant.tenant").init(argumentCollection=arguments) />
