<cfcomponent displayname="userRoleDAO" hint="table ID column = user_id,role_id,tenant_id">
	...
	<cffunction name="init" access="public" output="false" returntype="org.userRole.userRoleDAO">
	...
	<cffunction name="create" access="public" output="false" returntype="boolean">
		<cfargument name="userRole" type="org.userRole.userRole" required="true" />
	...
	<cffunction name="read" access="public" output="false" returntype="org.userRole.userRole">
		<cfargument name="userRole" type="org.userRole.userRole" required="true" />
