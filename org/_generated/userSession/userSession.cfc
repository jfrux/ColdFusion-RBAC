<cfcomponent displayname="userSession" output="false">
	...
	--->
	<cffunction name="init" access="public" returntype="org.userSession.userSession" output="false">
	...
	PUBLIC FUNCTIONS
	--->
	<cffunction name="setMemento" access="public" returntype="org.userSession.userSession" output="false">
