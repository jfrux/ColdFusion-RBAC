<cfcomponent displayname="userSessionDAO" hint="table ID column = user_id,session_id">
	...
	<cffunction name="init" access="public" output="false" returntype="org.userSession.userSessionDAO">
	...
	<cffunction name="create" access="public" output="false" returntype="boolean">
		<cfargument name="userSession" type="org.userSession.userSession" required="true" />
	...
	<cffunction name="read" access="public" output="false" returntype="org.userSession.userSession">
		<cfargument name="userSession" type="org.userSession.userSession" required="true" />
