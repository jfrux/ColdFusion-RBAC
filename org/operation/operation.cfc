<cfcomponent displayname="operation" output="false">
	...
	--->
	<cffunction name="init" access="public" returntype="org.operation.operation" output="false">
	...
	PUBLIC FUNCTIONS
	--->
	<cffunction name="setMemento" access="public" returntype="org.operation.operation" output="false">
