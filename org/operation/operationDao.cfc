<cfcomponent displayname="operationDAO" hint="table ID column = id">
	...
	<cffunction name="init" access="public" output="false" returntype="org.operation.operationDAO">
	...
	<cffunction name="create" access="public" output="false" returntype="boolean">
		<cfargument name="operation" type="org.operation.operation" required="true" />
	...
	<cffunction name="read" access="public" output="false" returntype="org.operation.operation">
		<cfargument name="operation" type="org.operation.operation" required="true" />
