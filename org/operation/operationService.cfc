<cfcomponent name="operationService" output="false">
	...
	<cffunction name="init" access="public" output="false" returntype="org.operation.operationService">
		<cfargument name="operationDAO" type="org.operation.operationDAO" required="true" />
		<cfargument name="operationGateway" type="org.operation.operationGateway" required="true" />
	...
	<cffunction name="getoperation" access="public" output="false" returntype="operation">
		...
		<cfset var operation = createObject("component","org.operation.operation").init(argumentCollection=arguments) />
