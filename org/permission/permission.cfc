<cfcomponent displayname="permission" output="false">
	...
	--->
	<cffunction name="init" access="public" returntype="org.permission.permission" output="false">
	...
	PUBLIC FUNCTIONS
	--->
	<cffunction name="setMemento" access="public" returntype="org.permission.permission" output="false">
