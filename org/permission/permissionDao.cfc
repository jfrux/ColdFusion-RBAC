<cfcomponent displayname="permissionDAO" hint="table ID column = id,name,object_id,operation_id">
	...
	<cffunction name="init" access="public" output="false" returntype="org.permission.permissionDAO">
	...
	<cffunction name="create" access="public" output="false" returntype="boolean">
		<cfargument name="permission" type="org.permission.permission" required="true" />
	...
	<cffunction name="read" access="public" output="false" returntype="org.permission.permission">
		<cfargument name="permission" type="org.permission.permission" required="true" />
