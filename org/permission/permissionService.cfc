<cfcomponent name="permissionService" output="false">
	...
	<cffunction name="init" access="public" output="false" returntype="org.permission.permissionService">
		<cfargument name="permissionDAO" type="org.permission.permissionDAO" required="true" />
		<cfargument name="permissionGateway" type="org.permission.permissionGateway" required="true" />
	...
	<cffunction name="getpermission" access="public" output="false" returntype="permission">
		...
		<cfset var permission = createObject("component","org.permission.permission").init(argumentCollection=arguments) />
