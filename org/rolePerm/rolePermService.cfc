<cfcomponent name="rolePermService" output="false">
	...
	<cffunction name="init" access="public" output="false" returntype="org.rolePerm.rolePermService">
		<cfargument name="rolePermDAO" type="org.rolePerm.rolePermDAO" required="true" />
		<cfargument name="rolePermGateway" type="org.rolePerm.rolePermGateway" required="true" />
	...
	<cffunction name="getrolePerm" access="public" output="false" returntype="rolePerm">
		...
		<cfset var rolePerm = createObject("component","org.rolePerm.rolePerm").init(argumentCollection=arguments) />
