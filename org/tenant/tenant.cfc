<cfcomponent displayname="tenant" output="false">
	...
	--->
	<cffunction name="init" access="public" returntype="org.tenant.tenant" output="false">
	...
	PUBLIC FUNCTIONS
	--->
	<cffunction name="setMemento" access="public" returntype="org.tenant.tenant" output="false">
