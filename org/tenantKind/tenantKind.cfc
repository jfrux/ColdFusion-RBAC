<cfcomponent displayname="tenantKind" output="false">
	...
	--->
	<cffunction name="init" access="public" returntype="org.tenantKind.tenantKind" output="false">
	...
	PUBLIC FUNCTIONS
	--->
	<cffunction name="setMemento" access="public" returntype="org.tenantKind.tenantKind" output="false">
