<cfcomponent displayname="userRole" output="false">
	...
	--->
	<cffunction name="init" access="public" returntype="org.userRole.userRole" output="false">
	...
	PUBLIC FUNCTIONS
	--->
	<cffunction name="setMemento" access="public" returntype="org.userRole.userRole" output="false">
