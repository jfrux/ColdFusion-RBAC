<cfcomponent displayname="roleDAO" hint="table ID column = id">
	...
	<cffunction name="init" access="public" output="false" returntype="rbac.role.roleDAO">
	...
	<cffunction name="create" access="public" output="false" returntype="boolean">
		<cfargument name="role" type="rbac.role.role" required="true" />
	...
	<cffunction name="read" access="public" output="false" returntype="rbac.role.role">
		<cfargument name="role" type="rbac.role.role" required="true" />
