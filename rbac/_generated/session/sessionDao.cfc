<cfcomponent displayname="sessionDAO" hint="table ID column = id">
	...
	<cffunction name="init" access="public" output="false" returntype="rbac.session.sessionDAO">
	...
	<cffunction name="create" access="public" output="false" returntype="boolean">
		<cfargument name="session" type="rbac.session.session" required="true" />
	...
	<cffunction name="read" access="public" output="false" returntype="rbac.session.session">
		<cfargument name="session" type="rbac.session.session" required="true" />
