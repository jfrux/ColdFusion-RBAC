<cfcomponent displayname="sessionRoleDAO" hint="table ID column = session_id,role_id">
	...
	<cffunction name="init" access="public" output="false" returntype="rbac.sessionRole.sessionRoleDAO">
	...
	<cffunction name="create" access="public" output="false" returntype="boolean">
		<cfargument name="sessionRole" type="rbac.sessionRole.sessionRole" required="true" />
	...
	<cffunction name="read" access="public" output="false" returntype="rbac.sessionRole.sessionRole">
		<cfargument name="sessionRole" type="rbac.sessionRole.sessionRole" required="true" />
