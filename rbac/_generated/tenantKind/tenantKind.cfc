<cfcomponent displayname="tenantKind" output="false">
	<!---
	PROPERTIES
	--->
	...
	--->
	<cffunction name="init" access="public" returntype="rbac.tenantKind.tenantKind" output="false">
	...
	PUBLIC FUNCTIONS
	--->
	<cffunction name="setMemento" access="public" returntype="rbac.tenantKind.tenantKind" output="false">
