<cfcomponent displayname="tenantKindDAO" hint="table ID column = id">
	...
	<cffunction name="init" access="public" output="false" returntype="rbac.tenantKind.tenantKindDAO">
	...
	<cffunction name="create" access="public" output="false" returntype="boolean">
		<cfargument name="tenantKind" type="rbac.tenantKind.tenantKind" required="true" />
	...
	<cffunction name="read" access="public" output="false" returntype="rbac.tenantKind.tenantKind">
		<cfargument name="tenantKind" type="rbac.tenantKind.tenantKind" required="true" />
