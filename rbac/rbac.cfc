<cfcomponent displayname="RBAC" hint="This is an implementation of NIST RBAC open standard for ColdFusion">
	...
	<cffunction name="init" access="public" returntype="rbac" hint="instantiates the rbac system">
		...
		<cfset this.objectDao = createObject("component","rbac.object.objectDao").init(dsn=variables.dsn) />
		<cfset this.objectGateway = createObject("component","rbac.object.objectGateway").init(dsn=variables.dsn) />
		<cfset this.objectService = createObject("component","rbac.object.objectService").init(this.objectDao,this.objectGateway) />
		
		<cfset this.operationDao = createObject("component","rbac.operation.operationDao").init(dsn=variables.dsn) />
		<cfset this.operationGateway = createObject("component","rbac.operation.operationGateway").init(dsn=variables.dsn) />
		<cfset this.operationService = createObject("component","rbac.operation.operationService").init(this.operationDao,this.operationGateway) />
		
		<cfset this.permissionDao = createObject("component","rbac.permission.permissionDao").init(dsn=variables.dsn) />
		<cfset this.permissionGateway = createObject("component","rbac.permission.permissionGateway").init(dsn=variables.dsn) />
		<cfset this.permissionService = createObject("component","rbac.permission.permissionService").init(this.permissionDao,this.permissionGateway) />
		
		<cfset this.roleDao = createObject("component","rbac.role.roleDao").init(dsn=variables.dsn) />
		<cfset this.roleGateway = createObject("component","rbac.role.roleGateway").init(dsn=variables.dsn) />
		<cfset this.roleService = createObject("component","rbac.role.roleService").init(this.roleDao,this.roleGateway) />
		
		<cfset this.rolePermDao = createObject("component","rbac.rolePerm.rolePermDao").init(dsn=variables.dsn) />
		<cfset this.rolePermGateway = createObject("component","rbac.rolePerm.rolePermGateway").init(dsn=variables.dsn) />
		<cfset this.rolePermService = createObject("component","rbac.rolePerm.rolePermService").init(this.rolePermDao,this.rolePermGateway) />
		
		<cfset this.sessionDao = createObject("component","rbac.session.sessionDao").init(dsn=variables.dsn) />
		<cfset this.sessionGateway = createObject("component","rbac.session.sessionGateway").init(dsn=variables.dsn) />
		<cfset this.sessionService = createObject("component","rbac.session.sessionService").init(this.sessionDao,this.sessionGateway) />
		
		<cfset this.sessionRoleDao = createObject("component","rbac.sessionRole.sessionRoleDao").init(dsn=variables.dsn) />
		<cfset this.sessionRoleGateway = createObject("component","rbac.sessionRole.sessionRoleGateway").init(dsn=variables.dsn) />
		<cfset this.sessionRoleService = createObject("component","rbac.sessionRole.sessionRoleService").init(this.sessionRoleDao,this.sessionRoleGateway) />
		
		<cfset this.tenantDao = createObject("component","rbac.tenant.tenantDao").init(dsn=variables.dsn) />
		<cfset this.tenantGateway = createObject("component","rbac.tenant.tenantGateway").init(dsn=variables.dsn) />
		<cfset this.tenantService = createObject("component","rbac.tenant.tenantService").init(this.tenantDao,this.tenantGateway) />
		
		<cfset this.tenantKindDao = createObject("component","rbac.tenantKind.tenantKindDao").init(dsn=variables.dsn) />
		<cfset this.tenantKindGateway = createObject("component","rbac.tenantKind.tenantKindGateway").init(dsn=variables.dsn) />
		<cfset this.tenantKindService = createObject("component","rbac.tenantKind.tenantKindService").init(this.tenantKindDao,this.tenantKindGateway) />
		
		<cfset this.userRoleDao = createObject("component","rbac.userRole.userRoleDao").init(dsn=variables.dsn) />
		<cfset this.userRoleGateway = createObject("component","rbac.userRole.userRoleGateway").init(dsn=variables.dsn) />
		<cfset this.userRoleService = createObject("component","rbac.userRole.userRoleService").init(this.userRoleDao,this.userRoleGateway) />
						
		<cfset this.userSessionDao = createObject("component","rbac.userSession.userSessionDao").init(dsn=variables.dsn) />
		<cfset this.userSessionGateway = createObject("component","rbac.userSession.userSessionGateway").init(dsn=variables.dsn) />
		<cfset this.userSessionService = createObject("component","rbac.userSession.userSessionService").init(this.userSessionDao,this.userSessionGateway) />
