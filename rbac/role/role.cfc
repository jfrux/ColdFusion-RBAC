<cfcomponent displayname="role" output="false">
	...
	--->
	<cffunction name="init" access="public" returntype="rbac.role.role" output="false">
	...
	PUBLIC FUNCTIONS
	--->
	<cffunction name="setMemento" access="public" returntype="rbac.role.role" output="false">
