<cfcomponent name="roleService" output="false">
	...
	<cffunction name="init" access="public" output="false" returntype="rbac.role.roleService">
		<cfargument name="roleDAO" type="rbac.role.roleDAO" required="true" />
		<cfargument name="roleGateway" type="rbac.role.roleGateway" required="true" />
	...
	<cffunction name="getrole" access="public" output="false" returntype="role">
		...
		<cfset var role = createObject("component","rbac.role.role").init(argumentCollection=arguments) />
