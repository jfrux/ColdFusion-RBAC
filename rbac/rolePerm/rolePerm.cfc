<cfcomponent displayname="rolePerm" output="false">
	...
	--->
	<cffunction name="init" access="public" returntype="rbac.rolePerm.rolePerm" output="false">
	...
	PUBLIC FUNCTIONS
	--->
	<cffunction name="setMemento" access="public" returntype="rbac.rolePerm.rolePerm" output="false">
