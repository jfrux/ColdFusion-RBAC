<cfcomponent displayname="rolePermDAO" hint="table ID column = role_id,permission_id">
	...
	<cffunction name="init" access="public" output="false" returntype="rbac.rolePerm.rolePermDAO">
	...
	<cffunction name="create" access="public" output="false" returntype="boolean">
		<cfargument name="rolePerm" type="rbac.rolePerm.rolePerm" required="true" />
	...
	<cffunction name="read" access="public" output="false" returntype="rbac.rolePerm.rolePerm">
		<cfargument name="rolePerm" type="rbac.rolePerm.rolePerm" required="true" />
