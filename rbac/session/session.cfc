<cfcomponent displayname="session" output="false">
	...
	--->
	<cffunction name="init" access="public" returntype="rbac.session.session" output="false">
	...
	PUBLIC FUNCTIONS
	--->
	<cffunction name="setMemento" access="public" returntype="rbac.session.session" output="false">
