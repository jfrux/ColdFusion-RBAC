<cfcomponent name="sessionRoleService" output="false">
	...
	<cffunction name="init" access="public" output="false" returntype="rbac.sessionRole.sessionRoleService">
		<cfargument name="sessionRoleDAO" type="rbac.sessionRole.sessionRoleDAO" required="true" />
		<cfargument name="sessionRoleGateway" type="rbac.sessionRole.sessionRoleGateway" required="true" />
	...
	<cffunction name="getsessionRole" access="public" output="false" returntype="sessionRole">
		...
		<cfset var sessionRole = createObject("component","rbac.sessionRole.sessionRole").init(argumentCollection=arguments) />
