<cfcomponent name="tenantKindService" output="false">
	...
	<cffunction name="init" access="public" output="false" returntype="rbac.tenantKind.tenantKindService">
		<cfargument name="tenantKindDAO" type="rbac.tenantKind.tenantKindDAO" required="true" />
		<cfargument name="tenantKindGateway" type="rbac.tenantKind.tenantKindGateway" required="true" />
	...
	<cffunction name="gettenantKind" access="public" output="false" returntype="tenantKind">
		...
		<cfset var tenantKind = createObject("component","rbac.tenantKind.tenantKind").init(argumentCollection=arguments) />
