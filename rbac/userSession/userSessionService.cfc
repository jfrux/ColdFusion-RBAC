<cfcomponent name="userSessionService" output="false">
	...
	<cffunction name="init" access="public" output="false" returntype="rbac.userSession.userSessionService">
		<cfargument name="userSessionDAO" type="rbac.userSession.userSessionDAO" required="true" />
		<cfargument name="userSessionGateway" type="rbac.userSession.userSessionGateway" required="true" />
	...
	<cffunction name="getuserSession" access="public" output="false" returntype="userSession">
		...
		<cfset var userSession = createObject("component","rbac.userSession.userSession").init(argumentCollection=arguments) />
